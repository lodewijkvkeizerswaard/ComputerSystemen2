...
def main():
    ...
    #GS: The one commented below is the original grading scheme for the assignment.
	# this has been modified for CS16
    ...
    trans32_score = computeMissScore(miss32, 300, 720, maxscore['trans32']) * int(result32[0])
    trans64_score = computeMissScore(miss64, 1300, 2400, maxscore['trans64']) * int(result64[0])
    trans61_score = computeMissScore(miss61, 2000, 3600, maxscore['trans61']) * int(result61[0])
